...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.5]{error_theta_eps0.0001_zbl.pdf} ~~
    \includegraphics[scale=0.5]{error_theta_eps0.0001_nlhlin_As_Si.pdf} \\ \smallskip
    \includegraphics[scale=0.5]{error_theta_eps0.1_zbl.pdf} ~~
    \includegraphics[scale=0.5]{error_theta_eps0.1_nlhlin_As_Si.pdf} \\ \smallskip
    \includegraphics[scale=0.5]{error_theta_eps100_zbl.pdf} ~~
    \includegraphics[scale=0.5]{error_theta_eps100_nlhlin_As_Si.pdf}
