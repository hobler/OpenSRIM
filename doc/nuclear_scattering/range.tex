...
\begin{equation}
    ...
    \frac{ \mathrm{d} R_\mathrm{p} }{ \mathrm{d} E } =
        \frac{ 1 }{ N (S_\mathrm{n}(E) + S_\mathrm{e}(E))}
        \left( 1 - \frac{ \mu N S_\mathrm{n}(E) }{ 2 E } R_\mathrm{p} \right),
...
The projected range ratios at 100~eV are shown for all atom pairs in \cref{fig:sn_rp_ratio_all}.
\begin{figure}
    \centering
