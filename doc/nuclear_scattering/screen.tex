...
\begin{figure}
    ...
    \includegraphics[scale=0.5]{ZBLuniv_unscaled.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{NLHlin_aFirsov.pdf} ~~
    \includegraphics[scale=0.5]{NLHlin_aZBL.pdf}
...
\end{equation}
%
inparticular for very dislike elements (such as $Z_1=1$ or $Z_1=92$ combined with all other $Z_2$).
%
