...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{sn_zbl_homo.pdf} ~~
    \includegraphics[scale=0.5]{sn_zbl_homo_e0.01.pdf} ~~ \\[\baselineskip]
    \includegraphics[scale=0.5]{sn_krc_homo.pdf} ~~
    \includegraphics[scale=0.5]{sn_krc_homo_e0.01.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{qn_zbl_homo.pdf} ~~
    \includegraphics[scale=0.5]{qn_zbl_homo_e0.01.pdf} \\[\baselineskip]
    \includegraphics[scale=0.5]{qn_krc_homo.pdf} ~~
    \includegraphics[scale=0.5]{qn_krc_homo_e0.01.pdf}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{sn_fit_Z5_14.pdf} ~~
    \includegraphics[scale=0.5]{qn_fit_Z5_14.pdf}
