...
def init_params():
    ...
    geometry_params, nelem, elements_params, nmat, materials_params = target.setup(input_params)
    estop_params = estop.setup(input_params, nelem, elements_params)
    recoil_params = recoil.setup(input_params)
    scatter_params = scatter.setup(input_params, nelem, elements_params)
